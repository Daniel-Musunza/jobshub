...
import {addhackathon, gethackathons } from '../features/hackathons/hackathonSlice';
    ...
    {user && (
        <div className='post-jobs'>
          ...
          <form onSubmit={toggleModal} method="POST" enctype="multipart/form-data">
            ...
            <textarea name="introduction" id="" cols="30" rows="10"
            ...
            <div className='editor'>
              <ReactQuill
                ...
                onChange={(e) => setDescription(e.target.value)} // Use the callback to handle content changes
                className='editor'
              />
            </div>
